            ...
            <div className="form-items">
              ...
              <form className="requires-validation p-5" noValidate>
                ...
                <div className="col-md-12 form-floating">
                  ...
                  <div className="invalid-feedback">El campo usuario no puede estar vacío!</div>
                </div>
                ...
                <div className="col-md-12 form-floating">
                  ...
                  <div className="invalid-feedback">El campo contraseña no puede estar vacío!</div>
                </div>
                ...
                <div className="col-md-12">
                  <p className="mt-5 mb-3 text-light d-flex justify-content-center">© MusicaTP - 2024</p>
                </div>
              </form>
            </div>
          </div>
